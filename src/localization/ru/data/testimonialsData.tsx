...
export const testimonialsData = {
    ...
    content: [
        ...
        },
        {
            ...
            text: [
                'Когда я\u00a0познакомился с\u00a0командой SmartHead в\u00a02018\u00a0году, они выполняли для нас 15-25 проектов в\u00a0год. Спустя 5\u00a0лет совместной работы мы\u00a0увеличили этот объем в\u00a0несколько раз, успешно завершая более 200 проектов по\u00a0разработке интерактивных и\u00a0медиа-продуктов ежегодно.',
                'Могу уверенно сказать, SmartHead предоставляет лучший сервис на\u00a0рынке.',
                'Команда предлагает наилучшие варианты решений, а\u00a0результаты всегда тщательно протестированы. Если у\u00a0них есть свое видение креатива, они всегда высказывают свои предложения, что особенно ценно. А\u00a0больше всего мне нравится стремление к\u00a0экспериментам и\u00a0новым нестандартным решениям.',
                'Уверенность в\u00a0качестве работы и\u00a0отличном сервисе делает SmartHead не\u00a0просто надежным партнёром, но\u00a0лидером, которого я\u00a0рекомендую всем на\u00a0рынке разработки.',
            ],
        },
        {
